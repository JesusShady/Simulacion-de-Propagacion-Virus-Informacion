...
public class main extends Application{
    ...
    private static final Strign APP_TITLE = "Simulador de propagacion de virus/informacion";
    ...
    public void start (Stage primaryStage){
        ...
        Scene scene = new Scene(view.getRoot(), WINDOW_HEIGHT, WINDOW_HEIGHT);
